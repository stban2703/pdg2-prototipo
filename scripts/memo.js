...
export function renderMemoIntro(user) {
    ...
    const memointroSeeAdmin = document.querySelector(".memointro-screen__intro-title--admin")
    const memoSeeMemosAdmin = document.querySelector(".memo-last-edit--seeMemos")
